...
function showResult(){
    ...
    if (userScore > 3){ // si result > 3
        ...
        let scoreTag = '<span> Plus de chance la prochaine fois <p>'+ userScore +'</p> / <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
 // Timer settings - uggghh - 5 jours 
function startTimer(time){
    ...
    function timer(){
        ...
        if(time < 0){ //si on a un timer value < 0
            ...
            next_btn.classList.add("show"); //DISPLAY NEXT
        }
    }
}
